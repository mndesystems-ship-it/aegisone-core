...
export function buildRemediationCases() {
    return [
        {
            test_id: "TC-061",
...
function main() {
    ...
    writeJsonArtifact(join(OUTPUT_DIR, "remediation_wave_results.json"), {
        summary,
        cases: results
    });
