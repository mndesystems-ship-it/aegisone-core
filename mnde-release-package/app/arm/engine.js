import { REASON_CODES, budgetTokenStore, executionAuthorityStore } from "../shared/index.js";
...
export function resetArmStores() {
    executionAuthorityStore.reset();
    budgetTokenStore.reset();
}
export function defineBudgetToken(token, maxBudgetCents) {
    budgetTokenStore.define(token, maxBudgetCents);
}
export function runStrictArm(input, orbit, requestHash) {
    ...
    if (projected === null) {
        return {
            ...
            ...input.execution_request.budget_token === undefined ? {} : {
                budget_token: input.execution_request.budget_token
            }
        };
    }
...
export function commitArmAllow(executionId, requestHash, decisionHash) {
